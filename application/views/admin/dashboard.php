...
<section style="margin-top:23px">
   <center> <h1>Admin-Recipies</h1></center>
</section>
<section>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:24px"><?= anchor("admin/editrecipe/{$i->id}",'Edit',['class'=>'btn btn-primary']); ?></td>
                        <td style="padding:24px"><?= anchor("admin/delrecipe/{$i->id}",'Delete',['class'=>'btn btn-danger']); ?></td>
                    </tr>
                    <?php } } 
                        else{ ?>
                            <tr>
